...
package com.ruyicai.lottery.controller.dto;
...
privileged aspect CaselotDTO_Roo_JavaBean {
    ...
    public Tuserachievement CaselotDTO.getAchievement() {
        return this.achievement;
    }
    
    public void CaselotDTO.setAchievement(Tuserachievement achievement) {
        this.achievement = achievement;
    }
    
    public Boolean CaselotDTO.getDisplayTlots() {
        return this.displayTlots;
    }
    
    public void CaselotDTO.setDisplayTlots(Boolean displayTlots) {
